    ...
    <div class="market-dialog" slot="content">
      <div
        ...
        v-sina-ads="{
                    ...
                    currentEventParams: {
                        jumplink: marketInfoData.icontext,
                    }
                }"
      >
      ...
      <img
        v-if="marketInfoData.icontext"
        class="el-full-img"
        :src="marketInfoData.icontext"
        @click="openJump"
      />
    </div>
  </Popup>
...
export default {
  ...
  data() {
    return {
      isShow: false,
      marketInfoUrl:
        process.env.staticPath + "/v1.1.0/king/pages/panda/#/marketInfo",
      marketInfoData: {
        icontext: null,
        isshield: 0,
        jumplink: "",
          ...
          .then(res => {
            if (res.code == 200 && res.data) {
              ...
              if (res.data.jumplink) {
                this.marketInfoUrl = res.data.jumplink;
              }
