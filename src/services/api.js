...
export default {
    ...
    activity: {
	    ...
	    queryPointsRule: request("/act/points/queryPointsRule","activity"), // 积分-查询积分规则
	    queryMyPoints: request("/act/points/queryMyPoints"), // 积分-查询用户的积分情况
	    queryPointsDetail: request("/act/points/queryPointsDetail","activity"), // 积分-查询积分明细
	    queryMyGoods: request("/act/drawgift/queryMyGoods","activity"), // 抽奖-查看我的奖品
	    dodraw: request("/act/drawgift/dodraw"), // 抽奖-点击抽奖
    },
    bank: {
