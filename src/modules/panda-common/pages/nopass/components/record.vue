<template>
  <div>
    <div class="record-wrap">
      <div class="no-record" v-if="isShowNodata && theme2">
        <div class="title">抱歉，暂无可借机构。</div>
        <div class="sub-title">为您收集了全市场最新机构，同时申请3家，通过率高达<span>92%</span></div>
      </div>
      <div class="no-record2" v-else-if="isShowNodata && theme1">
        <div class="title">抱歉，暂无可借机构。</div>
        <div class="sub-title">为您收集了全市场最新机构，同时申请3家，通过率高达92%</div>
      </div>
