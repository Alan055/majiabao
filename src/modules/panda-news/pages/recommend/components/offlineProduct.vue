<template lang="html">
    ...
    <div class="model offline-wrap" v-if="data">
        ...
        <div class="offline-content">
            <div class="c-flex-row c-flex-start c-v-center el-title">
                <dl class="el-title-left">大额贷款</dl>
                <dl class="el-title-right">线下贷款，面签拿大额</dl>
            </div>
            <div class="c-flex-row c-v-center ">
                ...
                <div class="c-col-40 el-btn">
                    <mt-button class="btn-round handle-button" size="normal" type="primary" @click.native="$root.openUrl({url: data.nextpage.url, isFull: false}, resdata)">立即前往</mt-button>
                </div>
            </div>
        </div>
    </div>
