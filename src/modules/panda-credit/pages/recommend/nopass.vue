        ...
        <div class="c-view-content">
            <div class="m-banner" >
                <div class="no-pass">
                  ...
                  <span class="title">抱歉，您的借款额度审批暂未通过</span>
                  <span class="tip">建议尝试提升征信后再来，<a @click="$root.openUrl({url: zhengxinURL, title: '征信查询'})">查看我的征信记录</a></span>
                </div>
            </div>
            <div class="m-content">
                ...
                <!-- 在线客服 -->
                <div class="section kefu-content" v-if="onlineServiceUrl" @click="$root.openUrl({url: onlineServiceUrl, title: '在线客服'})">
        ...
        if (
          ...
          list.map((item, index) => {
            ...
            if (item.type === "HUABEIURL" && item.showmodel === "2") {
              ...
              console.log("this.huabeiURL", this.zhengxinURL);
            }
