<template>
  <div class="view-step1 view-public-info-step" ref="view">
    <c-header title="身份信息">
      ...
      <div class="content-wrap" v-min-height>
        <div class="id-card-input">
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.pos">
            <p class="section-title">请上传身份证人像面</p>
            <photo-scan
          ...
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.opp">
            <p class="section-title">请上传身份证国徽面</p>
            <photo-scan
            ...
            <!--<p class="el-desc">{{formData.posimageurl ? '确保身份证完整清晰后再提交，点击可重拍' : '身份证完整，有效期清晰' }}</p>-->
          </div>


          <div class="onlineKefu" v-if="!formData.posimageurl">
            <mt-button  type="default" size="small" @click="$root.openUrl(onlineServiceURL);"
                        style="    padding: 0 15px;height: 32px;background: #fff;border: 1px solid #999999;border-radius: 16px;">
              <img class="c-icon icon_a" src="../../assets/images/kefu@2x.png" style="width: 20px;height: 20px;" />
              在线客服</mt-button>
          </div>
        ...
        <div class="onlineKefu1" v-if="formData.posimageurl">
          <mt-button  type="default" size="small" @click="$root.openUrl(onlineServiceURL);"
                      style="    padding: 0 15px;height: 32px;background: #fff;border: 1px solid #999999;border-radius: 16px;">
            <img class="c-icon icon_a" src="../../assets/images/kefu@2x.png" style="width: 20px;height: 20px;" />
            在线客服</mt-button>
