  ...
  data() {
    return {
      ...
      typeData: [
        {
          type: 1,
          iconurl: require("../images/helptype1.png"),
          title: "借款申请"
        },
        {
          type: 2,
          iconurl: require("../images/helptype2.png"),
          title: "授信问题"
        },
        {
          type: 3,
          iconurl: require("../images/helptype3.png"),
          title: "账户管理"
        },
        {
          type: 4,
          iconurl: require("../images/helptype4.png"),
          title: "还款问题"
        }
      ],
      moreLink: process.env.staticPath + "/v1.1.0/king/pages/panda-larger-welfare/#/news/more", //更多资讯
      detailLink: process.env.staticPath + "/v1.1.0/king/pages/panda-larger-welfare/#/news/detail" //资讯详情
    };
  },
  components: {
    watermark
