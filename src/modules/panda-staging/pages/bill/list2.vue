  ...
  <div class="view bill-detail-page">
    <div class="c-view-content c-bg-gray" v-min-height>
      ...
      <div class="bill-plan">
        ...
        <div class="list">
          <div :class="['list-item', item.isClear ? 'clear':'']" v-for="(item, i) in billList" :key="i"
      ...
      <div class="bill-detail-dialog" slot="content">
        ...
        <div class="dialog-content">
          ...
          <div class="dialog-list">
            <div class="dialog-list-item" v-for="(item, i) in detailData.billItemVOList" :key="i"
                 v-if="item.amount > 0">
	...
	export default {
		...
		methods: {
			gotoAgreements() {
				...
				console.log("是否是app", this.$root.isApp)
				if (this.$root.isApp) {
