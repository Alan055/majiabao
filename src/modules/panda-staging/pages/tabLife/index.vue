<template>
  <div v-if="tabLife.length||imgList.length">
    <pull-refresh v-model="isLoading" @refresh="onRefresh" ref="contentTab3" class="tabLife pull-refresh-home">
      <c-header ref="transparentHeader" :style="`color: #fff;`" class="header transparent" :title="''" :show="true">
        <!--<mt-button slot="left" @click=><c-icon type="back"/></mt-button>-->

        <mt-button slot="right" class="redPackets" @click="$root.openUrl(redPacketsUrl)">
          <img src="./../../assets/images/message-white@2x.png" alt="">
        </mt-button>
        <mt-button slot="right" class="message" @click="$root.openUrl(c)">
          <img src="./../../assets/images/message-white@2x.png" alt="">
        </mt-button>
      </c-header>
      <div slot="normal"><span class="down-tip"><i></i>下拉刷新</span></div>
      <div slot="pulling"><span class="down-tip"><i></i>下拉刷新</span></div>
      <div slot="loosing"><span class="up-tip"><i></i>松开刷新</span></div>
      <div slot="loading"><span class="refresh-tip"><i></i>正在刷新</span></div>
