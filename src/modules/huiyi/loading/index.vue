<template>
  <div class="loading">
    ...
    <div class="bg">
      ...
      <p><span class="c-red">额度</span>计算中</p>
    </div>
    ...
    <div class="step-info">
      <div class="wrap">
        <ul id="J_ul" :style="{transform: 'translateY(' + positionY + '%)'}">
          <li class="loading-item" v-for="(item, key) in list" :key='key'
    ...
    <div class="step-bar c-relative">
      ...
      <!--流程进度条 百分比线显示-->
      <div class="percent-redLine" :style="{width: percent + '%'}">
      </div>
        ...
        .loading-item{
          ...
          &.checking {
            ...
            &:last-child .loading-line{
              background: linear-gradient(180deg, #e8c096 50%,  #ffffff 50%)!important;
            }
