<template lang="html">
    <div class="view">
        ...
        <div class="c-layer" v-show="headerRgba != 0">
            <c-header ref="transparentHeader" class="header transparent" :style="`color: rgba(0, 0, 0, ${headerRgba}); background: rgba(255, 255, 255, ${headerRgba}); opacity: ${headerOpacity}`" :title="appName" :show="true">
            </c-header>
        </div>
