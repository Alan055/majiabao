<template lang="html">
    <div class="view">
        ...
        <div class="c-layer">
            <c-header ref="transparentHeader" class="header transparent" :style="`background: rgba(65, 70, 81, 0); opacity: 0`" :title="appName" :show="true">
        ...
        <scroller v-if="homeData.apiFinish" class="c-view-content" id="scrollerContent" :enableRefresh="true" :on-refresh="refresh" :offset="100" :bounce="60" :maxScrollerHeight="160" :power="2" @refreshFinsh="refreshFinsh" @onScroll="onScroll" @onPulling="onPulling">
            <div class="nopass-content">
                <div id="blockHeaderContent" class="block-header" ref="transparentBlock"></div>

                <div class="header-content">
                    <span class="center">
                        <img src="../images/header-logo@2x.png"/>
                    </span>
                    ...
                    <div class="has-thirdproducts" v-if="homeData.thirdproducts" >
                        <div class="title">很抱歉，您暂未匹配到借款机构。</div>
                        <div class="sub-title">建议您尝试线下贷款，最高额度可达20万元。</div>
                        <div class="triangle-border-down">
                            <span></span>
                        </div>
                    </div>
                    <div class="no-thirdproducts" v-else >
                        <img src="../images/nopass-nothrid.png"/>
                        <div class="title">很抱歉，您暂未匹配到借款机构。</div>
                        <div class="sub-title">建议您尝试线下贷款，最高额度可达20万元。</div>
                    </div>
                </div>
            ...
            <div class="section no-thirdproducts-kefu" @click="$root.openUrl({url: onlineServiceUrl, title: '在线客服'})" v-if="!homeData.thirdproducts && onlineServiceUrl">
                <img src="../images/kefu-img.png"/>
            </div>
        </scroller>
    </div>
</template>
...
.view {
  ...
  .nopass-content {
    background: url("../images/recommend-bg@2x.png") no-repeat;
    background-size: 100%;
    width: 100%;
    min-height: 230px;
