          ...
          <div class="content-wrap" v-min-height>
            ...
            <div class="c-section">
              <form-control
                ...
                :readonly="true"
              />
              <div class="address">{{formData.addr}}</div>
            </div>
            ...
            <div class="c-section">
              <form-control
                ...
                :readonly="true"
              />
              <div class="address">{{formData.companyaddr}}</div>
            </div>
      ...
      api.publicInfo
        ...
        .then(res => {
          ...
          let contacts = res.data.contacts.contacts.map(item => ({
            ...
            extratype: item.contacttype + ""
          }));
          let family = contacts.filter(
            item => [6, 7].indexOf(item.contacttype) == -1
          )[0];
          let friend = contacts.filter(item => item.contactType == 6)[0];
          let colleague = contacts.filter(item => item.contactType == 7)[0];
          // 获取 直系亲属关系
          ...
          let { posimageurl, oppimageurl, cardname, cardno } = res.data.idCard;
          this.formData = {
            family,
            friend,
            colleague,
