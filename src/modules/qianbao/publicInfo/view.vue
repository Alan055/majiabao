                    ...
                    <div class="content-wrap" v-min-height>
                      ...
                      <!--  <div class="c-section">
                        ...
                        <div class="bottom-info">
                            <img class="c-icon" src="~@/assets/images/publicInfo/ba_cg@2x.png" alt=""> 惠义贷款智能加密，保障您的信息安全
                        </div>
                    </div>
                </div>
            ...
            <mt-tab-container-item id="2" :class="{show: selected == 2}">
                <div class="c-view-content">
                    <div class="content-wrap" v-min-height>
                        ...
                        <div class="bottom-info">
                            <img class="c-icon" src="~@/assets/images/publicInfo/ba_cg@2x.png" alt=""> 惠义贷款不会向联系人泄漏您的正常借款信息
                        </div>
