<template lang="html">
  <div class="view c-bg-gray">
    <div class="introduce c-section">
      ...
      <p class="detail">
        {{appName2}}是{{mjbCompanyName}}旗下的贷款服务产品。产品结合普惠金融发展和互联网技术创新，致力于面向大众提供专业、快捷的服务，帮助客户解决资金难的问题。未来，{{appName2}}是将秉承谷誉“普惠金融，服务人人” 的服务宗旨，以方便快捷，健康诚信为本，通过持续不断的产品创新，为客户提供安全可靠的服务，持续为客户创造价值。
      </p>
    </div>
