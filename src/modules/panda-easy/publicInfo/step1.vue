  ...
  <div class="view-step1 view-public-info-step c-bg-gray" ref="view">
    ...
    <div class="c-view-content" ref="content">
      <div class="content-wrap" v-min-height>
          ...
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.pos">
            ...
            >
              <div
                class="default-img"
                slot="default-img"
                :style="`height: 105px; background: url(${require('../images/renxiang.png')}) no-repeat;background-size: 100% 100%;`"
              >
          ...
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.opp">
            ...
            >
              <div
                class="default-img"
                slot="default-img"
                :style="`height: 105px; background: url(${require('../images/guohui.png')}) no-repeat;background-size: 100% 100%;`"
              >
                <img src="../images/paishe.png" alt>
                <p class="paishe">点击扫描</p>
              </div>
        ...
        <div class="section-title" v-if="formData.posimageurl">您的身份信息识别为</div>
    ...
    handleBack() {
      ...
      if (this.backDialog) {
        ...
        //   cancelButtonText: button[0]
            message: '只差一步身份信息采集填写基本资料，即可快速到账，是否继续？',
          showCancelButton: true,
        ...
        if (
          ...
          if(this.onlineServiceURL){
                AppBridge.setWebTitleAttribute({
                    btnType: "img",
                    btnVal: process.env.kingPath + "/pages/panda-loan/static/icon/publicInfo/question.png"
                }, () => {
                    this.$root.openUrl({url: this.onlineServiceURL, title: '在线客服'})
                });

                console.log('设置了客服地址', process.env.kingPath + "/pages/panda-loan/static/icon/publicInfo/question.png")
            }
        }
      });
    },
