      ...
      <div class="grid-content c-bg-white">
        ...
        <div class="input text">
          <textarea class="c-font-m"
                    placeholder="您的意见是我们前进的动力，您的宝贵建议一经采纳，若您填写了联系方式，我们会送出惊喜小礼品哦~"
                    v-model="str"
...
<style lang="scss" scoped>
  ...
  .submitBtn {
    ...
    line-height: 48px;
    margin: 30px auto 0;
    background-image: linear-gradient(-90deg, #FDD108 0%, #FFDF37 100%);
    box-shadow: 0 2px 11px 0 rgba(255,198,108,0.50);
    border-radius: 24px;
