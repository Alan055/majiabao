        ...
        <div class="content-wrap">
            ...
            <ul class='c-border-t'>
                <li v-for='item in getOperator' @click='handleClick(item)'>
                    <img class='icon' src="../../assets/images/yys-icon.png" alt="">
                    <p>{{item.name + '认证'}}</p>
...
export default {
    ...
    computed: {
        ...
        style() {
            ...
            backgroundImage: "url(" + require(`../../assets/images/ybp${this.isAuth ? '500' : '350'}.png`) + ")",
            }
        },
        getOperator() {
            let result ;
...
.view-limit-increase{
    ...
    .banner {
        height: 290px;
        background: url('../../assets/images/getTrust-bg.png') no-repeat center center;
  ...
  .content-wrap{
        width: 100%;
        background: #FFFFFF;
        background: url('../../assets/images/getTrust-cricel.png') no-repeat top center;
