    ...
    <div class="view">
        <div class="c-view-content">
            <div class="message-list" ref="wrapper">
                <mt-loadmore :bottom-method="loadBottoma" @bottom-status-change="handleBottomChange" :bottom-all-loaded="allLoadedb" :bottomPullText='bottomText' ref="loadmoreb">
                    <div :class="['message-item']" v-for="item in list1" v-sinaAds="adsInfo.message.index.clickActMsgList" @click="goDetail(item, 'messageItemTwo')" :id="'messageItemTwo' + item.id">
                        <div class="card">
                            <p class="title">
                ...
                <div class="no-data" v-if="list1NoData">
                    <img src="../../assets/images/message-nodata.png" />暂无系统消息
                </div>
            </div>
        </div>
