          ...
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.pos">
            ...
            >
              <div
                class="default-img"
                slot="default-img"
                :style="`height: 105px; background: url(${require('../../assets/images/renxiang.png')}) no-repeat;background-size: 100% 100%;`"
              >
          ...
          <div class="card-list" v-sina-ads="stat.publicInfo.idCard.opp">
            ...
            >
              <div
                class="default-img"
                slot="default-img"
                :style="`height: 105px; background: url(${require('../../assets/images/guohui.png')}) no-repeat;background-size: 100% 100%;`"
              >
                <img src="../../assets/images/paishe.png" alt>
                <p class="paishe">点击扫描</p>
              </div>
        ...
        if (
          ...
          if(this.onlineServiceURL){
                AppBridge.setWebTitleAttribute({
                    btnType: "img",
                    btnVal: process.env.kingPath + "/pages/panda-flash/static/icon/publicInfo/question.png"
                }, () => {
                    this.$root.openUrl({url: this.onlineServiceURL, title: '在线客服'})
                });

                console.log('设置了客服地址', process.env.kingPath + "/pages/panda-flash/static/icon/publicInfo/question.png")
            }
        }
      });
    },
