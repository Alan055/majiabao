<template>
    <div class="refuseList-warp" v-if="!noRefuseData">
        ...
        <div class="refuse-list">
          ...
          <span class="c-flex-item c-tl title">
            ...
            {{item.name}}{{computedXmdriver(item)}}
          </span>

                    <span class="c-flex-item c-tr">
            <span class="state" v-html="item.text2[0] && item.text2[0].content"></span>
          </span>
                </p>
          ...
          <span class="c-flex-item c-tl count">
                <p
                    class="sub-title color-gary"
                >{{item.text1[0] && item.text1[0].content ? item.text1[0].content : '申请金额(元)' }}</p>
    ...
    <no-data :imgUrl="require('../../assets/images/no-bill@2x.png')" text="您暂时没有拒件记录" v-else></no-data>
</template>
