<template lang="html">
    ...
    <div class="billIndex" v-if="dataList.length">
        ...
        <diversionXmLoan 
            ...
            cachkey="bill"
            :statdata="{
                click: adsInfo.diversionXmLoan.billclick,
                close: adsInfo.diversionXmLoan.billclickclose,
                popover: adsInfo.diversionXmLoan.billpopover
            }"
        ></diversionXmLoan>
    </div>
        ...
        methods: {
            ...
            loadBottoma(token) {
                ...
                api.user.bill.index(params).then(res => {
                    ...
                    if(res.mainPackageBillDriverConfig) {
                        this.mainPackageBillDriverConfig = res.mainPackageBillDriverConfig;
